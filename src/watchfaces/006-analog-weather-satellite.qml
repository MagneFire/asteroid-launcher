            ...
            Item {
                ...
                Canvas {
                    ...
                    onPaint: {
                        ...
                        ctx.beginPath();
                        ctx.arc(weatherBox.width / 2, weatherBox.height / 2, weatherBox.width * 0.43, 270 * rad, 360, false);
                        ctx.stroke();
                        ctx.closePath();
                        ctx.beginPath();
            ...
            Item {
                ...
                Canvas {
                    ...
                    onPaint: {
                        ...
                        ctx.beginPath();
                        ctx.fillStyle = "#22ffffff";
                        ctx.arc(dayBox.width / 2, dayBox.height / 2, dayBox.width * 0.43, 270 * rad, 360, false);
                        ctx.strokeStyle = boxColor;
                        ctx.lineWidth = innerArcLineWidth;
                        ctx.stroke();
                        ctx.fill();
            ...
            Item {
                ...
                Canvas {
                    ...
                    onPaint: {
                        ...
                        ctx.beginPath();
                        ctx.fillStyle = "#22ffffff";
                        ctx.arc(batteryBox.width / 2, batteryBox.height / 2, batteryBox.width * 0.43, 270 * rad, 360, false);
                        ...
                        ctx.beginPath();
                        ctx.arc(batteryBox.width / 2, batteryBox.height / 2, batteryBox.width * 0.43, 270 * rad, ((batteryBox.value / 100 * 360) + 270) * rad, false);
                        ctx.stroke();
                        ctx.closePath();
                    }
                }
